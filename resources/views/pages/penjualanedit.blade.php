                                    ...
                                    <table class="table table-bordered" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr row_id="{{ $counter }}">
                                                ...
                                                <td class='border border-5'><input style='width:120px;' readonly form='thisform' class='namakartuclass form-control' name='nama_kartu_d[]' type='text' value='{{ $penjualands[$i]->nama }}'></td>
