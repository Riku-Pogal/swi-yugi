...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/belakang_kartu.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/back_card.png">
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no" name="viewport">
    <title>APPS PENJUALAN KARTU</title>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/mwarna">APPS Penjualan Kartu</a>
                    </div>
